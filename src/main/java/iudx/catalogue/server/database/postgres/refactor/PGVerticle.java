...
import static iudx.catalogue.server.util.Constants.RF_PG_SERVICE_ADDRESS;
...
public class PGVerticle extends AbstractVerticle {
  ...
  public void start() throws Exception {
    ...
    pgService = new PGServiceImpl(this.pool);

    binder = new ServiceBinder(vertx);
    consumer = binder.setAddress(RF_PG_SERVICE_ADDRESS).register(PGService.class, pgService);
    LOGGER.info("Refactor Postgres verticle started.");
  }
