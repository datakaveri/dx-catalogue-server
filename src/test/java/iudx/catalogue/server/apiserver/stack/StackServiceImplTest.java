...
//
//    Future<StacCatalog> resultFuture = stackService.create(stacCatalog);
//
//    resultFuture.onComplete(
//        handler -> {
//          if (handler.succeeded()) {
//            Item result = handler.result();
//            testContext.completeNow();
//          } else {
...
//    StacLink stacLink = new StacLink(stack);
//    JsonArray links =
...
//    Future<String> updateFuture = stackSevice.update(stacLink);
//
...
//    Future<String> deleteFuture = stackSevice.delete(stackId);
//
