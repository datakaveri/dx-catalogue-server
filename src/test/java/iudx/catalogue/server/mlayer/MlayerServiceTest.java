...
//    mlayerService = new MlayerServiceImpl(webClient, esService,
//        postgresService, jsonObject);
//
//    json = requestJson();
//    MlayerInstanceRequest instanceRequest = new MlayerInstanceRequest(json);
...
//    mlayerService
//        .createMlayerInstance(instanceRequest)
//        .onComplete(
//            handler -> {
...
//    mlayerService = new MlayerServiceImpl(webClient, esService, postgresService,
//        jsonObject);
//    JsonObject request = requestJson();
//    MlayerInstanceRequest instanceRequest = new MlayerInstanceRequest(request);
//    when(esService.search(any(), any())).thenReturn(Future.succeededFuture(List.of()));
...
//
//    mlayerService
//        .updateMlayerInstance(instanceRequest)
//        .onComplete(
//            handler -> {
//              if (handler.succeeded()) {
...
//    MlayerDomainRequest domainRequest = new MlayerDomainRequest(request);
//
//    mlayerService = new MlayerServiceImpl(webClient, esService, postgresService,
//        jsonObject);
//
...
//
//    mlayerService
//        .createMlayerDomain(domainRequest)
//        .onComplete(
//            handler -> {
//              if (handler.succeeded()) {
//                verify(esService, times(1)).createDocument(any(), any());
...
//
//    mlayerService
//        .updateMlayerDomain(domainRequest)
//        .onComplete(
//            handler -> {
//              if (handler.succeeded()) {
...
//    MlayerGeoQueryRequest geoQueryModel = new MlayerGeoQueryRequest(request);
...
//
//    mlayerService
//        .getMlayerGeoQuery(geoQueryModel)
//        .onComplete(
//            handler -> {
...
//
//    mlayerService
//        .getMlayerAllDatasets(request.getInteger(LIMIT), request.getInteger(OFFSET))
//        .onComplete(
//            handler -> {
//              if (handler.succeeded()) {
...
//    MlayerDatasetRequest datasetRequest = new MlayerDatasetRequest(request);
//
...
//
//    mlayerService
//        .getMlayerDataset(datasetRequest)
//        .onComplete(
//            handler -> {
//              if (handler.succeeded()) {
